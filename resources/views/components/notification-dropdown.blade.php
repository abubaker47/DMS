        ...
        <div class="divide-y divide-gray-100">
            ...
            <template x-if="!error && notifications.length > 0">
                <div>
                    ...
                    <a href="{{ route('notifications.index') }}" style="display:block; margin:20px;" class="block bg-gray-50 text-center py-2 text-sm font-medium text-indigo-600 hover:text-indigo-500">
